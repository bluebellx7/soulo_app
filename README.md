...
多平台搜索浏览器 - 一次输入，快速切换 40+ 搜索与 AI 平台

## 项目概述

搜罗是一款多平台搜索浏览器。用户输入一次关键词，即可在抖音、B站、Google、YouTube、DeepSeek、通义千问等 40+ 搜索与 AI 平台之间快速切换。Soulo 不生成或合并第三方平台的答案；搜索历史和配置默认保存在本地设备。
